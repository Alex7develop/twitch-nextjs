  ...
  return (
    <div id="live" className="p-2 md:p-8">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-4 py-2">
        <LiveChannelItem
          img={Live1}
          profile_img="https://static-cdn.jtvnw.net/jtv_user_pictures/55a2affe-13c1-4e21-82bc-0d98d92d7cf2-profile_image-70x70.png"
        ...
        <LiveChannelItem
          img={Live2}
          profile_img="https://static-cdn.jtvnw.net/jtv_user_pictures/d8b9e514-ab4a-4690-8578-33f6fe449722-profile_image-70x70.png"
        ...
        <LiveChannelItem
          img={Live3}
          profile_img="https://static-cdn.jtvnw.net/jtv_user_pictures/qojqva-profile_image-a209b7bcf1dd2104-70x70.jpeg"
        ...
        <LiveChannelItem
          img={Live7}
          profile_img="https://static-cdn.jtvnw.net/jtv_user_pictures/admiralbulldog-profile_image-888d5b80958e636f-70x70.jpeg"
